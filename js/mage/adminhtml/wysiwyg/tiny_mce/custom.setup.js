...
tinyMceWysiwygSetup.prototype =
{
    ...
    getSettings: function(mode)
    {
        ...
        var settings = {
            ...
            theme : 'advanced',
            plugins : plugins,
            theme_advanced_buttons1 : magentoPlugins + 'magentowidget,|,undo,redo,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,styleselect,formatselect,|,tablecontrols,|,fullscreen,|',
            theme_advanced_buttons2 : 'code,|,cleanup,removeformat,|,bold,italic,underline,strikethrough,|,sub,sup,|,justifyleft,justifycenter,justifyright,|,bullist,numlist,outdent,indent,|,styleprops,|,blockquote,cite,abbr,acronym,del,ins,attribs,|,link,unlink,anchor,|,charmap,media,advhr,image,|',
